...
let g:Lf_NormalMap = {
    ...
    \   ["<C-p>", ':exec g:Lf_py "fileExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "bufExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "mruExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "tagExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "bufTagExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "functionExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "lineExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "historyExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "selfExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "colorschemeExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "windowExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "jumpsExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "commandExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "filetypeExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "gtagsExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "helpExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "qfloclistExplManager._previewResult(True)"<CR>'],
    ...
    \   ["<C-p>", ':exec g:Lf_py "rgExplManager._previewResult(True)"<CR>'],
...
" 拷贝hover之内容
nnoremap <silent> yK :call <SID>yankHoverContent()<CR>

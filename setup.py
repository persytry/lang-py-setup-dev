...
def main() -> None:
    ...
    parser.add_argument('--sed', default=None, nargs='?', choices=('hk', 'usagate', 'vim', 'nvim'), const='hk', help='all选项不会起作用,必须单独指定')
    parser.add_argument('--nvim', default=False, action='store_true')
    parser.add_argument('--vim', default=False, action='store_true', help='all选项不会起作用,必须单独指定')
    parser.add_argument('--dbg', default=False, action='store_true')
    parser.add_argument('--cpdbg', default=None, nargs='?', const='', help='all选项不会起作用,必须单独指定')
    ...
    parser.add_argument('--keymap', default=False, action='store_true', help='all选项不会起作用,必须单独指定')
    parser.add_argument('--minidlna_src', default=False, nargs=1, help='input minidlna code source path. all选项不会起作用,必须单独指定')
